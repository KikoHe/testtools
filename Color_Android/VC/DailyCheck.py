...
class VC(unittest.TestCase):
    ...
    def test_bannerad(self):
        driver = self.driver
        click_by_id(driver, "root_view", "library_root", index=1)
        is_element_has_children_by_xpath(driver, "/hierarchy/android.widget.\
FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout\
/android.widget.LinearLayout/android.widget.FrameLayout/android.view\
.ViewGroup/android.view.ViewGroup/android.view.ViewGroup[2]/android.widget.FrameLayout", wait_time=100)
    ...
    def test_case_2(self):
        ...
        print("new pics number：" + str(pic_num))
