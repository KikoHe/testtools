...
def updateExcel(file_path):
    ...
    try:
        ...
        for r in list(range(rows_num))[4:]:  # 取第4行到最后一行
            for c in list(range(clos_num))[9:]:
...
# 测试表格存放路径
test_cases_path = project_path + "/testcase/"

# 执行
updateExcel(test_cases_path + "BitColor_3.28.0_新增多语言文案.xlsx")