...
def pic_config(address,offset):
    url_prefixes = {
        "PBN": f"https://pbn-cms.learnings.ai/paint/v1/cms/paint?limit=1000&offset={offset}&category_id=&authors=&color_type=&size_type=&tags=&with_preformance=false&status_list=&sort_by=c_time%5E-1&is_resource_update=IGNORE",
        "ZC": f"https://zc-cms.learnings.ai/colorflow/v1/cms/abtest/default/detail?limit=500&offset=0&release_date=2024-05-14%5E2024-05-14",
        "VC": f"https://vc-cms.learnings.ai/vitacolor/v1/cms/abtest/default/detail?limit=500&offset=0&release_date=2024-05-01%5E2024-05-05",
        "BP": f"https://bpbncms.idailybread.com/bpbn/v1/cms/abtest/logic_item/test_a/list/trending?limit=200&offset=0&category_key=trending&size=&is_colored=false&is_gif=false&status=0&show_type=0&release_date_start=20240501&release_date_end=20240505&id_or_filename=&with_scores=true",
        "Vista": f"https://colorpad-cms.learnings.ai/colorpad/v1/cms/abtest/default/detail?limit=50&offset=0&release_date=2024-05-01%5E2024-05-05"
    }
    headers = {
